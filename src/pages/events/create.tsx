...
const Create = () => {
  ...
  return (
    <div className="mx-auto my-4 flex max-w-2xl flex-col rounded-2xl bg-white p-10">
      <div className="mb-10 space-y-2">
        <h1 className="text-2xl font-semibold">Creating a new event</h1>
        <p className="text-slate-400">
          Once you create your event a moderator will verify its legitimacy and
          then publish to the events page. This can sometimes take 2-3 days.
        </p>
      </div>{' '}
      <form
        action={`/${currentTitle}`}
